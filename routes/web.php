...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/parking_lot', [ParkingLotController::class, 'create'])->middleware('auth');;
    Route::post('/parking_lot', [ParkingLotController::class, 'store'])->middleware('auth');;

    Route::get('/parking_lots', [ParkingLotController::class, 'index'])->middleware('auth');;
});
